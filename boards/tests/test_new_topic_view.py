...
class NewTopicTests(TestCase):
	...
	def setUp(self):
		...
		User.objects.create_user(username='john', email='john@doe.com', password='123456test')
		self.client.login(username='john', password='123456test')
	...
	def test_new_topic_not_found_status_code(self):
		new_topic_url = reverse('new_topic', kwargs={'pk': 99})
		response = self.client.get(new_topic_url)
